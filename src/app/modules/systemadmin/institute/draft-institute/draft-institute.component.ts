...
@Component({
  selector: 'app-draft-institute',
  templateUrl: './draft-institute.component.html',
  styleUrls: ['./draft-institute.component.scss']
})


export class DraftInstituteComponent implements OnInit {
