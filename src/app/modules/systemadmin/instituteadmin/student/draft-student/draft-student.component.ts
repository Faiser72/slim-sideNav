...
@Component({
  selector: 'app-draft-student',
  templateUrl: './draft-student.component.html',
  styleUrls: ['./draft-student.component.scss']
})
export class DraftStudentComponent implements OnInit {
